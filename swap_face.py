...
WORKFLOWS: dict[str, dict] = {
    ...
    "qwen_swap": {
        "workflow_id": "2067266054715432961",
        "webapp_id": "2067275723093659650",
        "ref": "13.image", "target": "10.image",
        "api_mods": {"5": {"prompt": "把图1中人物的脸和发型替换成图2中人物的"
                                      "脸和发型，严格保持图1人物的姿势、表情、"
                                      "服装、背景和光线完全不变"}},
        "note": "双图 Qwen-Edit-Plus 指令路线(姿势迁移流改造): image1(10链)=被换脸图"
